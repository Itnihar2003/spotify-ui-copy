...
class rowarrange extends StatelessWidget {
  rowarrange({super.key, required this.listname, required this.imagename, });
final List listname;
    ...
    return ListView.builder(
      itemCount:listname.length,
        ...
        itemBuilder: (BuildContext context, int index) {
          return Image.asset(imagename[index]);
        },
      );}
        // return Stack(children: [
        //   Container(child: Image.asset(imagename[index]),),
        //   Builder(builder:(context) => Container(child: Text("hii"), ))
        // ],);
